...
class Molecule:
    def __init__(self, atom_types, bond_types, positions, charges, atom_decoder, template_idx=None, centroid_pos=None):
        ...
        self.centroid_pos = torch.from_numpy(centroid_pos).to(positions.device)
    ...
    def build_molecule(self, atom_decoder, verbose=False):
        ...
        if self.centroid_pos is not None:
            positions = positions + self.centroid_pos
